...
alt="Class Enrichment, Significance and Importance by DAA Tools and SHAP Values. Binary heatmap showing the enrichment of the top 25 significant classes from ANCOM-BC2 between Control (blue) and Drought (red) groups for the three methods used for DAA (DESeq2, ANCOM-BC2, ALDEx2) with an alpha &lt;0.05, and SHAP values obtained from the RFC. Corresponding bar plots comparing -log_{10}(p_adjust) values (orange) and mean(|SHAP values|) (green)." />
...
alt="Order Enrichment, Significance and Importance by DAA Tools and SHAP Values. Binary heatmap showing the enrichment of the top 25 significant orders from ANCOM-BC2 between Control (blue) and Drought (red) groups for the three methods used for DAA (DESeq2, ANCOM-BC2, ALDEx2) with an alpha &lt;0.05, and SHAP values obtained from the RFC. Corresponding bar plots comparing -log_{10}(p_adjust) values (orange) and mean(|SHAP values|) (green)." />
...
alt="Family Enrichment, Significance and Importance by DAA Tools and SHAP Values. Binary heatmap showing the enrichment of the top 25 significant families from ANCOM-BC2 between Control (blue) and Drought (red) groups for the three methods used for DAA (DESeq2, ANCOM-BC2, ALDEx2) with an alpha &lt;0.05, and SHAP values obtained from the RFC. Corresponding bar plots comparing -log_{10}(p_adjust) values (orange) and mean(|SHAP values|) (green)." />
...
alt="Genera Enrichment, Significance and Importance by DAA Tools and SHAP Values. Binary heatmap showing the enrichment of the top 25 significant genera from ANCOM-BC2 between Control (blue) and Drought (red) groups for the three methods used for DAA (DESeq2, ANCOM-BC2, ALDEx2) with an alpha &lt;0.05, and SHAP values obtained from the RFC. Corresponding bar plots comparing -log_{10}(p_adjust) values (orange) and mean(|SHAP values|) (green)." />
